      ...
      <section className='bg-slate-700/50 rounded-2xl p-6 md:p-8 space-y-4'>
        ...
        <div className='grid md:grid-cols-2 gap-6 text-sm text-slate-300'>
          <div>
            ...
            <p>
              Improve your strategic thinking with games like Blackjack and
              Texas Hold'em. Practice probability, memory, and decision-making
              skills.
            </p>
          </div>
          <div>
            ...
            <p>
              Flip Card and memory-based games help enhance cognitive function

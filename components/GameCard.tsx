...
export default function GameCard({ title, description, emoji = '🎴' }: Props) {
  return (
    <div className="rounded-lg bg-white/5 backdrop-blur ring-1 ring-white/10 flex flex-col items-center justify-center gap-3 p-6 hover:scale-[1.02] transition h-full">
